...
void witness_verify_256(const bf128_t* bf_q, const uint8_t* delta, bf128_t* b_vec,
                        unsigned int lambda, const uint8_t* t, const uint8_t* r,
                        unsigned int height, unsigned int ell_hat,
                        const std::vector<signature_t>& srl);
...
void leave_verify_256(const bf128_t* bf_q, const uint8_t* delta, bf128_t* b_vec);
...
void merkle_tree_prove_256(const uint8_t* w, const bf128_t* bf_v, bf128_t* a_0_vec,
                           bf128_t* a_1_vec, bf128_t* a_2_vec, unsigned int height);

void merkle_tree_verify_256(const bf128_t* bf_q, const uint8_t* delta, bf128_t* b_vec,
                            unsigned int height);
